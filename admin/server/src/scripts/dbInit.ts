  ...
  { name: '首页', type: MenuType.MENU, path: '/dashboard', component: 'dashboard/index', icon: 'DashboardOutlined' },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { name: '新增组织', type: MenuType.BUTTON, perms: 'system:dept:add' },
          { name: '编辑组织', type: MenuType.BUTTON, perms: 'system:dept:edit' },
          { name: '删除组织', type: MenuType.BUTTON, perms: 'system:dept:remove' },
        ],
      },
      {
        name: '代码库管理',
